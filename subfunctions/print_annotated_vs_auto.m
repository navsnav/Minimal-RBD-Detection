...
for p=1:length(EMG_feats)
    ...
    R = corrcoef(max(table2array(EMG_Metric(:,dur_idx)),table2array(EMG_Metric(:,per_idx))),max(table2array(EMG_Auto_Metric(:,dur_idx)),table2array(EMG_Auto_Metric(:,per_idx))),'rows','complete');
...
%     max_val = ceil(max(table2array(EMG_Metric(:,dur_idx))));
    max_val = ceil(max(max(table2array(EMG_Metric(~rbd,dur_idx)),table2array(EMG_Metric(~rbd,per_idx)))));
