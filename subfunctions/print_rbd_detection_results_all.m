function    print_rbd_detection_results_all(results_f_all,names_all,tablename,print_figures,print_folder)
...
op_t_rbd_det_all = [op_t_rbd_det_all;op_t_rbd_all_cell{t}];
end


op_t_rbd_det = cell2table(op_t_rbd_det_all,'VariableNames',{'Accuracy','Sensitivity','Specificity','Precision','Recall','F1','Kappa'},...
    'RowNames',names_all);

fig_rbd_det = figure('units','normalized','outerposition',[0 0 1 1]);

uitable(fig_rbd_det,'Data', op_t_rbd_det_all,'ColumnName',op_t_rbd_det.Properties.VariableNames,...
