function [features, features_struct_30s,eeg_data_signal,features_struct] = FeatExtract_EEG_mini(data_signal1, fs,epoch_time,feature_time,std_flag)
...
if std_flag == 1 
    ...
    data_signal1 = data_signal1./std(data_signal1(:));        
end
