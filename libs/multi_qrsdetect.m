...
% Use P&T
normsig = signal./median(signal(qrs{2})); % normalized amplitude
feat_amp = var(normsig(qrs{2})); % QRS variations in amplitude
feat_amp2 = std(normsig(qrs{2})); % QRS variations in amplitude
feat_amp3 = mean(diff(normsig(qrs{2}))); % QRS variations in amplitude
